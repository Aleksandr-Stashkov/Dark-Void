...
public class LaserManager : MonoBehaviour
{
    ...
    public void CreateLaser(Player player)
    {
        if (player == null)
        {
            Debug.LogAssertion("Laser Manager was handled an empty player reference.");
        }
        else
        {
            GameObject newLaser;
    ...
    public void CreateEnemyLaser(Transform enemy)
    {
        if (enemy == null)
        {
            Debug.LogAssertion("Laser Manager was handled an empty Enemy reference.");
        }
        else
        {
    ...
    public void AddLaserToReserve(GameObject laser)
    {
        if (laser == null)
        {
            Debug.LogAssertion("Laser Manager was handled an empty Laser reference.");
        }
        else
        {
